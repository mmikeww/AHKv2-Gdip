# AHKv2-Gdip
This repository contains the GDI+ library (Gdip_All.ahk) compatible with [AHK v2-a094](https://autohotkey.com/v2/) and also backwards compatible with AHK v1.1.28.02  

AHK v2 made many changes to the syntax, which is why changes were needed. We have attempted to keep it backwards compatible with AHK v1.1. If you find any errors please report them in the Issues.  
